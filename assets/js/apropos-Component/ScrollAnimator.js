  ...
  onIntersection(entries) {
    ...
    entries.forEach(
      function (objetVisible) {
        ...
        if (intersecte) {
          element.classList.add("visible"); // Ajoute la classe 'visible' pour activer l'animation
        } else {
          element.classList.remove("visible"); // Retire la classe 'visible' si l'élément sort de la zone
        }
